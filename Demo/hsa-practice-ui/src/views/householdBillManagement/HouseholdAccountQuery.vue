  ...
  <div class="page-box">
    ...
    >
      <el-form
        ...
        label-width="70px"
      >
        <el-form-item label="账户余额" class="show-acctBalc-item">
          <el-input v-model="acctBalc.acctBalc" disabled size="mini">
          </el-input>
        </el-form-item>
        <el-form-item label="收入次数" class="show-acctBalc-item">
          <el-input v-model="acctBalc.incCnt" disabled size="mini"> </el-input>
        </el-form-item>
        <el-form-item label="收入总额" class="show-acctBalc-item">
          <el-input v-model="acctBalc.incSumAmt" disabled size="mini">
          </el-input>
        </el-form-item>
        <el-form-item label="支出次数" class="show-acctBalc-item">
          <el-input v-model="acctBalc.payCnt" disabled size="mini"> </el-input>
        </el-form-item>
        <el-form-item label="支出总额" class="show-acctBalc-item">
          <el-input v-model="acctBalc.paySumAmt" disabled size="mini">
          </el-input>
        </el-form-item>
      </el-form>
      <MyTable
...
export default {
  ...
  data () {
    return {
      ...
      targetTable: [{
        ...
        targetTableWidth: '',
        targetTableProp: 'pay_sum',
        targetTableLabel: '支出总额'
      }, {
        targetTableWidth: '',
        targetTableProp: 'pcount',
        targetTableLabel: '支出次数'
      }
      ],
  ...
  methods: {
    ...
    selectBtn (item) {
      if (item) {
        this.selectForm.certno = item.selectFormInput[1].vModel
        this.selectForm.name = item.selectFormInput[0].vModel
        if (this.selectForm.certno === undefined || this.selectForm.name === undefined) {
          return this.$message({
            type: 'error',
      ...
      this.$http.post(`${this.$http.defaults.baseURL}/qury/quryFmAcctInfo?certno=${this.selectForm.certno}&name=${this.selectForm.name}`
      ).then((res) => {
        console.log(res)
        if (item) {
        ...
        this.tableData = res.data.data.payMap
        this.acctBalc = res.data.data
